...
//		}
		...
		Parameters<GeneticProgramming> params = (Parameters<GeneticProgramming>) gp.getDefaultParameters();
...
//		String title = new String("Dubina ulaznog stabla, samo grow kreiranje stabala\n");
//		try {
//			Files.write(Paths.get("statistics.txt"), title.getBytes(), StandardOpenOption.APPEND);
//
//			GeneticProgramming gp = new GeneticProgramming();
//			MultithreadedSimulator simulator = new MultithreadedSimulator();
//			simulator.generateGrids(100, 50, 10, 10, false);
...
//
//				params.setParameter(GeneticProgrammingParameters.CROSSOVER_RATE, depth);
//
//				double bottles = 0;
//				double wallsHit = 0;
//				double emptyPickup = 0;
...
//				emptyPickup /= 10;
//				
//				String param = new String("Max dubina: " + params.getParameter(GeneticProgrammingParameters.CROSSOVER_RATE).getValue() + "\n");
//				Files.write(Paths.get("statistics.txt"), param.getBytes(),StandardOpenOption.APPEND);
//				String statistics = new String("Broj boca " + bottles + "; Zabijanja " + wallsHit
//						+ "; prazna saginjanja " + emptyPickup + "\n");
//				Files.write(Paths.get("statistics.txt"), statistics.getBytes(),StandardOpenOption.APPEND);
//
//			}
//
//		} catch (IOException e) {
