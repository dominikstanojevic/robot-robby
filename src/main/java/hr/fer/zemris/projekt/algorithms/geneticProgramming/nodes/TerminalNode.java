 ...
 * terminal node of the program tree. Each terminal node contains one 
 * {@link Move} and it always evaluates to this move.
 * </p>
...
public class TerminalNode implements Node {
	...
	/**
	 * Returns a random TerminalNode containing one {@link Move}. Each move
