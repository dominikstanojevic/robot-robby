...
public class GeneticProgrammingParameters implements Parameters<GeneticProgramming> {
    ...
    public GeneticProgrammingParameters() {
        ...
        parameters.put(CROSSOVER_RATE, new Parameter(CROSSOVER_RATE, ParameterType.DOUBLE,
                MIN_CROSSOVER_RATE, MAX_CROSSOVER_RATE, DEFAULT_CROSSOVER_RATE));
        parameters.put(MUTATION_RATE, new Parameter(MUTATION_RATE, ParameterType.DOUBLE,
                MIN_MUTATION_RATE, MAX_MUTATION_RATE, DEFAULT_MUTATION_RATE));
        parameters.put(POPULATION_SIZE, new Parameter(POPULATION_SIZE, ParameterType.INTEGER,
                MIN_POPULATION_SIZE, MAX_POPULATION_SIZE, DEFAULT_POPULATION_SIZE));
        parameters.put(GENERATION_NUM, new Parameter(GENERATION_NUM, ParameterType.INTEGER,
                MIN_GENERATION_NUM, MAX_GENERATION_NUM, DEFAULT_GENERATION_NUM));
        ...
        parameters.put(CROSSOVER_TREE_DEPTH, new Parameter(CROSSOVER_TREE_DEPTH,
                ParameterType.INTEGER, MIN_CROSSOVER_TREE_DEPTH, MAX_CROSSOVER_TREE_DEPTH,
                DEFAULT_CROSSOVER_TREE_DEPTH));
        parameters.put(EMPTY_PICKUP_PENALTY, new Parameter(EMPTY_PICKUP_PENALTY,
                ParameterType.INTEGER, MIN_EMPTY_PICKUP_PENALTY, MAX_EMPTY_PICKUP_PENALTY,
                DEFAULT_EMPTY_PICKUP_PENALTY));
        parameters.put(HITTING_WALL_PENALTY, new Parameter(HITTING_WALL_PENALTY,
                ParameterType.INTEGER, MIN_HITTING_WALL_PENALTY, MAX_HITTING_WALL_PENALTY,
                DEFAULT_HITTING_WALL_PENALTY));
        parameters.put(BOTTLE_PICKUP_PRIZE, new Parameter(BOTTLE_PICKUP_PRIZE,
                ParameterType.INTEGER, MIN_BOTTLE_PICKUP_PRIZE, MAX_BOTTLE_PICKUP_PRIZE,
                DEFAULT_BOTTLE_PICKUP_PRIZE));
    ...
    public LinkedHashSet<Parameter> getParameters() {
        ...
        // paramSet.add(new Parameter(p.getName(), p.getType(), p.getMinValue(),
        // p.getMaxValue(), p.getValue()));
        // }
        // return paramSet;
