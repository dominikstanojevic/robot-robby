...
/**
 * An implementation of {@link Robot} used in {@link GeneticProgrammin}
 * algorithm.
 * 
...
public class Individual implements Robot, Comparable<Individual> {
    ...
    /**
     * Created a new Individual with a given tree and previously evaluated raw
     * fitness.
     * 
     * @param rawFitness
     *            previously evaluated fitness
     * @param tree
     *            program tree
     */
    ...
    /**
     * Returns the raw fitness of the individual. The fitness is 0 if the
     * individual has not yet been evaluated.
     * 
     * @return raw fitness
     */
    ...
    /**
     * Returns new Individual with a random tree which has maximum depth greater
     * or equal to given maximal depth.
     * 
     * @param maxDepth
     ...
     * @param full
     *            whether tree should be full or not
    ...
    public int compareTo(Individual ind) {
        if (this.rawFitness < ind.rawFitness)
            return -1;
        else if (this.rawFitness > ind.rawFitness)
            return 1;
        return 0;
    }
