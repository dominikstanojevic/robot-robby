...
/**
 * <p>
 * Defines a basic set of functionality that every {@link Robot} training
 * algorithm should implement in order to be used properly from the program.
 * </p>
 * <p>
 * The needed functionality is the following:
 * </p>
 * <ul>
...
public interface Algorithm {
     ...
     *
     * @param filePath
     *            The path of the file that contains the information for this
     *            algorithm.
     * @return the robot created from the data in the file.
     * @throws IOException
     *             if an I/O error is encountered when reading from the file
     * @throws RobotFormatException
     *             if the algorithm parameters are written in an incorrect
     *             format
     */
     ...
     *
     * @param filePath
     *            The path to the file where the information should be written.
     * @throws IOException
     *             if an I/O error is encountered when writing to a file
     */
     ...
     * Note that this method should return a deep copy of the parameters, as the
     ...
     *
     * @param simulator
     *            simulator to test the results on
     * @param parameters
     *            parameters to run the algorithm with
