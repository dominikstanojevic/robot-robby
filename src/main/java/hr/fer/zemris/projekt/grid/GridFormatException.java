...
/**
 * Exception thrown when an application attempts to convert the contents of a file or string into an
 * {@link IGrid}, but the file/string does not have the appropriate format.
 *
