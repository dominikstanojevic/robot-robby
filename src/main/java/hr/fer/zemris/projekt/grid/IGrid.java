...
public interface IGrid {
     ...
     *
     * @param row
     *            index of the row to position the robot on
     * @param column
     *            index of the column to position the robot on
     */
    void setStartingPosition(int row, int column);

    /**
     * Returns true if the grid still has uncollected bottles in it, false
     * otherwise.
     *
     * @return true if the grid still has uncollected bottles in it, false
     *         otherwise.
     */
     ...
     *            the number of bottles that should be on the grid.
     * @param hasWalls
     *            a boolean flag that defines if there are walls inside of the
     *            grid or not.
     */
     ...
     *
     * @param gridField
     *            the basking matrix for the new grid.
     * @param startRow
     *            the starting row for the robot.
     * @param startColumn
     *            the starting column for the robot.
     */
     ...
     *
     * @param filePath
     *            the path to the file describing the grid.
     * @throws IOException
     *             if an I/O error occurs when reading from the file.
     * @throws GridFormatException
     *             if the file is written in an incorrect format
     */
     ...
     *
     * @param filePath
     *            the path to the file where the grid should be written.
     * @throws IOException
     *             if an I/O error occurs when reading from the file.
     */
